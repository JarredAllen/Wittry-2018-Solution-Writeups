...
public class FunctionsGoneWild2018StudentTest extends junit.framework.TestCase {
    ...
    public void testFunctionEight01() {
        assertEquals("TEST MESSAGE", FunctionsGoneWild2018.f8(FunctionsGoneWild2018.f8("TEST MESSAGE")));
        assertEquals("THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG", FunctionsGoneWild2018.f8(FunctionsGoneWild2018.f8("THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG")));
    }

    public void testFunctionTwo01() {
        assertEquals(20, FunctionsGoneWild2018.f2(0,100));
        assertEquals(20, FunctionsGoneWild2018.f2(1,100));
        assertEquals(19, FunctionsGoneWild2018.f2(2,100));
        assertEquals(19, FunctionsGoneWild2018.f2(3,100));
        assertEquals(19, FunctionsGoneWild2018.f2(4,100));
        assertEquals(19, FunctionsGoneWild2018.f2(5,100));
        assertEquals(19, FunctionsGoneWild2018.f2(6,100));
        assertEquals(18, FunctionsGoneWild2018.f2(7,100));
        assertEquals(18, FunctionsGoneWild2018.f2(8,100));
        assertEquals(18, FunctionsGoneWild2018.f2(9,100));
        assertEquals(18, FunctionsGoneWild2018.f2(10,100));
    }

    public void testFunctionTwo02() {
